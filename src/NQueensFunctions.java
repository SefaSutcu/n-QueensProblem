...
public class NQueensFunctions {
    ...
    public static Problem<NQueensBoard, QueenAction> createProjectFormulationProblem(int boardSize, NQueensBoard.Config config) {
        return new GeneralProblem<>(new NQueensBoard(boardSize, config), NQueensFunctions::getIFActions,
                NQueensFunctions::getResult, NQueensFunctions::testGoal);
    }
