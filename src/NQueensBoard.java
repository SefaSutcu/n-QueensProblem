...
public class NQueensBoard {
	...
	public enum Config {
		EMPTY, QUEENS_IN_FIRST_ROW, QUEEN_IN_EVERY_COL, QUEENS_IN_PROJECT
	}
	...
	public NQueensBoard(int size, Config config) {
		...
		} else if (config == Config.QUEENS_IN_PROJECT) {
			addQueenAt(new XYLocation(0, 3));
			addQueenAt(new XYLocation(1, 1));
		}
	}
